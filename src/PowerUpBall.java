...
public class PowerUpBall extends MovableObject {
    ...
    public PowerUpBall(double posX, double posY, double width, double height, double velX, double velY, double speed,
                       double dirX, double dirY, int screenWidth, int screenHeight, PowerUpType powerUpType) {
